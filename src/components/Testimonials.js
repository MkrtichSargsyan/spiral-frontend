...
function Testimonials() {
  return (
    <section className="px-40 py-10 bg-black opacity-95">
      ...
      <div className="flex justify-between">
        <article className="text-gray-100 font-caramel text-3xl flex-1 flex flex-col">
          ...
          <cite className="font-serif">Andrew Firestone</cite>
        </article>
        <article className="text-gray-100 font-caramel text-3xl flex-1 mx-10 flex flex-col">
          <q className="mb-10">
          ...
          <cite className="font-serif">Tim & Sue Peoples</cite>
        </article>
        <article className="text-gray-100 font-caramel text-3xl flex-1 flex flex-col">
          <q className="mb-10">
          ...
          <cite className="font-serif">John Clark</cite>
        </article>
      </div>
    </section>
  );
